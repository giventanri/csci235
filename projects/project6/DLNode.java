...
public class DLNode {
     ...
     * POSTCONDITION: this node is between before and (old) before.next()
     */
    public void spliceAfter(DLNode before) {
        // place this between before and (old) before.next() 
        next = before.next();
        previous = before; 
        
        // update next and previous of surronding nodes
        if (before.next() != null) {
